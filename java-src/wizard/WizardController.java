...
public class WizardController implements ActionListener {
    ...
    private void nextButtonPressed() {
        ...
        if (descriptor instanceof StartPanelDescriptor && ((StartPanelDescriptor)descriptor).isInstall()){
        	
        	StartPanelDescriptor startDescriptor= (StartPanelDescriptor) descriptor;
        	
        	if (!startDescriptor.validateEmail()){
        		JOptionPane.showMessageDialog(null,"You must enter a valid email address for the BIRCH administrator");
        		return;
        	}
        }
